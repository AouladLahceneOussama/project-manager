<form class="w-full py-2 px-8 mt-4 h-full overflow-y-auto">
    ...
    <div class="w-full mb-3">
        <span class="text-gray-400 text-xs ">{{ __('Add the informations of the subcategory')}}</span>
        <div class="bg-gray-200 w-full h-px"></div>
    </div>
    ...
    <div class="w-full mb-3">
        <div class="flex justify-end items-center">
            <button wire:click.prevent="save" class="bg-gray-700 text-white py-2 px-5 rounded-md text-sm cursor-pointer mb-1">{{ __('Modify')}}</button>
        </div>
    </div>
