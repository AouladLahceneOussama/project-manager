                    ...
                    <form method="post" class="w-full py-2 px-8 mt-4 h-full overflow-y-auto">
                        ...
                        <div class="flex flex-wrap -mx-3 mb-4">
                            ...
                            <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                                ...
                                <input type="text" name="name" class="text-size-sm leading-5.6 ease-soft block w-full appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding px-3 py-2 font-normal text-gray-700 transition-all focus:border-gray-500 focus:outline-none focus:transition-shadow" placeholder="Name" id="name" />
                            ...
                            <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                                ...
                                <input type="email" name="email" class="text-size-sm leading-5.6 ease-soft block w-full appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding px-3 py-2 font-normal text-gray-700 transition-all focus:border-gray-500 focus:outline-none focus:transition-shadow" placeholder="Email" id="email" />
